...
import { QuillConfig, CustomModule } from 'ngx-15-quill-2/config';
...
export declare class QuillService {
    ...
    /** @internal */
    beforeRender(Quill: any, customModules: CustomModule[] | undefined, beforeRender?: import("ngx-15-quill-2/config").QuillBeforeRender): Observable<any>;
    /** @internal */
